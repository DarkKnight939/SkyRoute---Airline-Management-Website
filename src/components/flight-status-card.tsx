      ...
      <CardContent className="space-y-4">
        ...
        {(gate || terminal) && (
            <div className="border-t pt-4 mt-4">
                <h3 className="text-md font-semibold mb-2 text-foreground">Gate & Terminal</h3>
                 <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                    {gate && <p className="flex items-center"><DoorOpen className="h-4 w-4 mr-2 text-muted-foreground" /> Gate: <span className="font-medium ml-1">{gate}</span></p>}
                    {terminal && <p className="flex items-center"><Building className="h-4 w-4 mr-2 text-muted-foreground" /> Terminal: <span className="font-medium ml-1">{terminal}</span></p>}
                 </div>
            </div>
        )}
      </CardContent>
